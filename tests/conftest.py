...
from virtualenv.info import IS_PYPY, IS_GRAALPY, IS_WIN, fs_supports_symlink
...
if IS_PYPY or IS_GRAALPY or (IS_WIN and sys.version_info[0:2] >= (3, 13)):  # https://github.com/adamchainz/time-machine/issues/456
